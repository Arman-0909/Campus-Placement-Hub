...
<body class="login-page">
    ...
    <div class="login-card card" style="position: relative; z-index: 10;">
        <div class="login-header">
            ...
            <p class="text-muted">Update your administrative credentials</p>
        </div>
        ...
        <form action="../admin/admin_forgot_password.php" method="post">
            ...
            <button type="submit" class="btn btn-secondary" style="width: 100%; justify-content: center; background: var(--secondary); color: white;">
                Update Password
            </button>
        </form>

        <div class="text-center" style="margin-top: 2rem; padding-top: 1.5rem; border-top: 1px solid var(--border);">
            <a href="../admin/admin_login.php" class="text-sm text-muted hover:text-primary flex items-center justify-center gap-2">
